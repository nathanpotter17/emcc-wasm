...
var ASM_CONSTS = {
  195825: () => { console.log("Starting OpenCV test!"); },  
 195867: ($0, $1, $2) => { const imageDataLength = $0 * $1 * 4; const rawData = new Uint8ClampedArray(Module.HEAPU8.buffer, $2, imageDataLength); console.log("Image data length: " + rawData.length); console.log("Image width (cols): " + $0); console.log("Image height (rows): " + $1); console.log("Expected length: " + imageDataLength); if (rawData.length !== imageDataLength) { console.error("Error: Image data length mismatch."); return; } const canvas = Module.canvas; const ctx = canvas.getContext('2d'); const imageData = new ImageData(rawData, $0, $1); ctx.putImageData(imageData, 0, 0); },  
 196437: () => { console.log("Completed drawing!"); }
};
function initCanvas() { if (!Module.canvas) { const existingCanvas = document.querySelector('canvas'); if (existingCanvas) { Module.canvas = existingCanvas; } else { const canvas = document.createElement('canvas'); canvas.width = 128; canvas.height = 128; document.body.appendChild(canvas); Module.canvas = canvas; } } }
...
var _drawGrayscale = Module['_drawGrayscale'] = createExportWrapper('drawGrayscale', 0);
...
var dynCall_iijiiii = Module['dynCall_iijiiii'] = createExportWrapper('dynCall_iijiiii', 8);
var dynCall_iijiiiiii = Module['dynCall_iijiiiiii'] = createExportWrapper('dynCall_iijiiiiii', 10);
var dynCall_iijiiiiiiii = Module['dynCall_iijiiiiiiii'] = createExportWrapper('dynCall_iijiiiiiiii', 12);
var dynCall_iiiijiiiiii = Module['dynCall_iiiijiiiiii'] = createExportWrapper('dynCall_iiiijiiiiii', 12);
var dynCall_iiiijiiiiiiii = Module['dynCall_iiiijiiiiiiii'] = createExportWrapper('dynCall_iiiijiiiiiiii', 14);
