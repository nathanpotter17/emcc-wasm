...
export class Game {
    ...
    update(keys) {
        ...
        wasm.game_update(this.__wbg_ptr, ptr0, len0);
    }
    draw() {
        wasm.game_draw(this.__wbg_ptr);
    }
}
...
const SceneManagerFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_scenemanager_free(ptr >>> 0, 1));

export class SceneManager {

    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(SceneManager.prototype);
        obj.__wbg_ptr = ptr;
        SceneManagerFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        SceneManagerFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_scenemanager_free(ptr, 0);
    }
    /**
     * @returns {SceneManager}
     */
    static new() {
        const ret = wasm.scenemanager_new();
        return SceneManager.__wrap(ret);
    }
    /**
     * @param {number} x
     * @param {number} y
     ...
     * @param {number} height
     */
    add_obstacle(x, y, width, height) {
        wasm.scenemanager_add_obstacle(this.__wbg_ptr, x, y, width, height);
    }
    /**
     * @param {number} x
     * @param {number} y
     ...
     * @returns {boolean}
     */
    is_colliding(x, y, width, height) {
        const ret = wasm.scenemanager_is_colliding(this.__wbg_ptr, x, y, width, height);
        return ret !== 0;
    }
    /**
     ...
     */
    draw(context) {
        wasm.scenemanager_draw(this.__wbg_ptr, context);
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('wasm_gol_bindgen_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
